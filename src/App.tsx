  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/location-voiture-tanger-aeroport" element={<Home />} />
        <Route path="/location-voiture-pas-cher-tanger" element={<Home />} />
        <Route path="/location-voiture-luxe-tanger" element={<Home />} />
        <Route path="/location-voiture-automatique-tanger" element={<Home />} />
        <Route path="/location-voiture-7-places-tanger" element={<Home />} />
